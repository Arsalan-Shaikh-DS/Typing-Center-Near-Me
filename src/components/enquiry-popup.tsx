      ...
      {open && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-3xl bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col md:flex-row max-h-[90vh] overflow-y-auto md:overflow-visible"
          >
            <button
              type="button"
              onClick={dismiss}
              aria-label={t("close")}
              className="absolute top-3 end-3 z-10 w-9 h-9 rounded-full flex items-center justify-center text-outline bg-white/80 hover:bg-surface-container hover:text-primary transition-colors"
            >
              <span className="material-symbols-outlined">close</span>
            </button>

            {/* Image: top on mobile, left column on desktop — different crops for each */}
            <div className="relative w-full h-40 md:h-auto md:w-2/5 shrink-0">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src="/images/popup/enquiry-popup-mobile.jpg"
                alt=""
                aria-hidden="true"
              ...
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src="/images/popup/enquiry-popup.jpg"
                alt=""
                aria-hidden="true"
