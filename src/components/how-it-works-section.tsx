...
import { HowItWorksVideoBackground } from "@/components/how-it-works-video-background";
...
export async function HowItWorksSection() {
  ...
  return (
    <section id="how-it-works" className="relative py-20 px-margin-mobile md:px-margin-desktop overflow-hidden">
      <HowItWorksVideoBackground />

      <div className="relative z-10 max-w-container-max mx-auto">
        {/* Heading */}
        <div className="text-center max-w-2xl mx-auto mb-16 md:mb-20">
          <span className="inline-flex items-center gap-2 bg-secondary text-white font-label-md text-label-md tracking-widest uppercase px-4 py-1.5 rounded-full">
            {t("eyebrow")}
          </span>
          <h2 className="font-display-lg text-white mt-3 drop-shadow-md">
          ...
          <div className="flex items-center justify-center gap-3 mt-6">
            ...
            <span className="material-symbols-outlined icon-fill text-white text-[16px]">
              diamond
            </span>
            <span className="h-px w-10 bg-white/50" />
          </div>
        ...
        <div className="md:hidden relative max-w-xl mx-auto">
          ...
          <div className="absolute left-1/2 top-10 bottom-10 -translate-x-1/2 w-0 border-l-2 border-dashed border-white/50" />
            ...
            {steps.map((step, index) => {
              ...
              return (
                ...
                >
                  {/* Card */}
                  <div
                    className={`relative w-[82%] sm:w-[76%] rounded-2xl bg-surface-container-lowest border-l-4 border-secondary shadow-lg p-5 flex items-center gap-4 ${
                  ...
                  >
                    ...
                    <div>
                      ...
                      <span
                        className={`block h-[3px] w-8 rounded-full bg-secondary mb-2 ${
                          isEven ? "" : "ml-auto"
                        }`}
                      />
                    ...
                    >
                      <span className="absolute inset-[-6px] rounded-full border-2 border-dashed border-white/70 bg-white/10 backdrop-blur-sm" />
        ...
        <div className="hidden md:block relative pt-7">
          ...
          <div className="absolute left-[10%] right-[10%] top-7 h-0 border-t-2 border-dashed border-white/50" />

          <div className="grid grid-cols-5 gap-6">
            {steps.map((step) => (
              <div
                key={step.number}
                className="relative rounded-2xl bg-surface-container-lowest border-t-4 border-secondary shadow-lg pt-10 pb-6 px-5 flex flex-col items-center text-center gap-3"
              >
                ...
                <span className="h-[3px] w-8 rounded-full bg-secondary" />
                <p className="font-body-md text-[14px] text-on-surface-variant">
                  {step.description}
                </p>
              </div>
        ...
        <div className="flex items-center justify-center gap-3 mt-16 md:mt-20">
          ...
          <span className="material-symbols-outlined icon-fill text-white text-[20px]">
            spa
          </span>
          <span className="h-px w-16 bg-white/50" />
        </div>
