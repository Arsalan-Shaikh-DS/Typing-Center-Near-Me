...
export function NewsletterForm() {
  ...
  if (status === "success") {
    return (
      <p className="font-body-md text-sm text-white flex items-center gap-2">
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} noValidate className="flex gap-2">
      ...
      <button
        ...
        className="shrink-0 h-11 px-5 bg-secondary-fixed text-white font-label-md text-sm rounded-full hover:opacity-90 transition-opacity disabled:opacity-60"
      >
