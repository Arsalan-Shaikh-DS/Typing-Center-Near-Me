      ...
      <main id="main-content" className="px-margin-mobile md:px-margin-desktop pb-24">
        <div className="max-w-container-max mx-auto grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <aside className="lg:col-span-1">
            <div className="sticky top-28 glass-panel p-8 rounded-2xl bg-white border border-surface-variant">
              ...
              <a
                ...
                className="w-full flex items-center justify-center gap-2 bg-primary text-white font-label-md text-label-md px-6 py-4 rounded-xl hover:bg-primary-container transition-colors mb-3"
              >
              ...
              <Link
                href="/#enquiry"
                className="w-full flex items-center justify-center gap-2 border-2 border-primary text-primary font-label-md text-label-md px-6 py-4 rounded-xl hover:bg-primary/5 transition-colors"
              >
                {t("requestCallback")}
              </Link>
            </div>
